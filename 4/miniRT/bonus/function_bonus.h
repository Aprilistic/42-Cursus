...
void	parse_ambient(char **splited_line, t_mlx *mlx, int *errno,
			int *cap_cnt);
void	parse_camera(char **splited_line, t_mlx *mlx, int *errno,
			int *cap_cnt);
void	parse_light(char **splited_line, t_mlx *mlx, int *errno);
void	parse_background(char **splited_line, t_mlx *mlx, int *errno,
			int *cap_cnt);
...
double	parse_atod(char **str, int *errno);
